...
void api_serial(void)
{
    ...
    xobj->single_turn(0x1, +1, 200, 9000);
    sleep(1);
...
void read_stat(uint8_t id, int8_t ret, X10ApiSerial *xobj)
{
    ...
    ret = xobj->Motor_runtime(0x1, runtime);
    printf("Motor runtime----> %d | %d\n", ret, runtime);
}
